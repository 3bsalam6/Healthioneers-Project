<?php
function renderAccountView($admin, $message, $error, $modalError, $modalMessage) {
    ?>
    <!doctype html>
    <html lang="en">
    <head>
    ...
    <div class="account-card">
        ...
        <?php if ($admin): ?>
            <form method="POST">
                ...
                <input type="text" name="fname" value="<?= htmlspecialchars($admin['Admin_Fname']); ?>" required>
                <label>Last Name</label>
                <input type="text" name="lname" value="<?= htmlspecialchars($admin['Admin_Lname']); ?>" required>
                <label>Username</label>
                <input type="text" name="username" value="<?= htmlspecialchars($admin['Admin_Username']); ?>" required>
    ...
    <script>
        ...
        window.addEventListener('keydown', e => {
            if (e.key === 'Escape') passModal.style.display = 'none';
        });
    </script>
