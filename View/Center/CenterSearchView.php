<?php
function renderCenterSearchView($results, $message, $error) {
    ?>
    <!doctype html>
    <html lang="en">
    <head>
    ...
    <main class="container">
        ...
        <form method="POST" class="search-box">
            <input type="text" name="search_term" placeholder="🔍 Search by Reservation ID, Patient Name, or Vaccine Name" required>
            <button type="submit" name="search_reservation">Search</button>
        </form>
